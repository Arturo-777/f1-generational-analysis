/* =============================================================
   VIEW: vw_F1_Generation_Performance
   PURPOSE: Consolidate driver, season, and championship data 
            for generation-based performance analysis.
   ============================================================= */
...
-- Preview sample data from the view
